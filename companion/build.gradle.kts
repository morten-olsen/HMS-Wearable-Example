...
plugins {
    id("com.android.application") // Changed to application
    id("kotlin-android")
...
android {
    defaultConfig {
        applicationId = "com.fprieto.hms.wearable.companion" // Changed applicationId
    ...
    signingConfigs {
        getByName("debug") {
            ...
            storeFile = file("../keystore/debug.keystore") // Adjusted path assuming modules are siblings
...
dependencies {
    ...
    implementation(project(":shared")) // For MessagingModels
